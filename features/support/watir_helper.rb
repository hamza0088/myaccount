module WatirHelper
  ...
  module ClassMethods
    # three methods - one to put data in a text field, another
    ...
    # three methods - one to put data in a hidden field, another
    ...
    # four methods - one to select an item in a drop-down,
    ...
    # three methods - one to check, one to uncheck and
    ...
    # four methods - one to select, another to clear, 
    ...
    # three methods - one click a button, another
    ...
    # three methods - one to select a link, another
    ...
    # a method that returns a table element
    #
    ...
    # two methods - one to return the text within
    ...
    # a method to return the text of a table data <td> element
    ...
    # a method that returns the content of a <div>
    ...
    # a method that returns the content of a <p>
    # and another method that returns the div element
    #
    ...
    # a method that returns the content of a <dd>
    ...
    # a method that returns the content of a <dl>
    ...
    # a method that returns the content of a <dt>
    ...
    # a method that returns the content of an h6
